...
\begin{frame}{Pricing Using Fundamentals}
    ...
    \vspace{0.5em}
    But if we include the \textbf{buy-sell spread} (effective depreciation $> 10\%$):
    ...
    \begin{table}
        ...
        \begin{tabular}{@{}cccc@{}}
            \toprule
            \textbf{Eff. 3M Dep.} & \textbf{Market Value} & \textbf{Payoff} & \textbf{PV of Payoff} \\
            \midrule
            2.5\% & 12,51,805 & 0 & 0 \\
            10.0\% & 11,55,513 & 128 & 126 \\
            12.0\% & 11,29,835 & 25,806 & 25,295 \\
            15.0\% & 10,91,318 & 64,323 & 63,050 \\
            \bottomrule
        \end{tabular}
    \end{table}
\end{frame}
...
\begin{frame}{Adding Deterministic Depreciation}
    ...
    \vspace{0.5em}
    \textbf{Key modelling point:} Since depreciation is explicitly in the stock price, we use the \emph{standard} risk-neutral probability $p$ -- no adjustment needed (avoids double-counting).
...
\begin{frame}{Consolidated Pricing}
    \begin{table}
        ...
        \begin{tabular}{@{}lcc@{}}
            ...
            \midrule
            Fundamental (10\% eff. dep.) & -- & 126 \\
            Fundamental (12\% eff. dep.) & -- & 25,295 \\
